  ...
  return (
    <AdminLayout title="لوحة التحكم">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-muted dark:text-gray-400 text-sm">إجمالي المستخدمين</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.counts.users}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-muted dark:text-gray-400 text-sm">الاختبارات</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.counts.exams}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-muted dark:text-gray-400 text-sm">التسجيلات</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.counts.submissions}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">معدل الإكمال</h2>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted dark:text-gray-400 text-sm">نسبة إكمال الاختبارات</p>
            </div>
          </div>
        </div>
        
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">متوسط الدرجات</h2>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted dark:text-gray-400 text-sm">متوسط درجات المستخدمين</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 mb-8">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">أفضل الاختبارات</h2>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <th className="text-right py-3 px-4 text-muted dark:text-gray-400 font-medium">الاختبار</th>
                <th className="text-right py-3 px-4 text-muted dark:text-gray-400 font-medium">عدد التسجيلات</th>
                <th className="text-right py-3 px-4 text-muted dark:text-gray-400 font-medium">متوسط الدرجات</th>
                </tr>
              </thead>
              <tbody>
              {stats.topExams.map((exam, index) => (
                <tr key={index} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                  <td className="py-3 px-4 text-gray-900 dark:text-white">{exam.name}</td>
                  <td className="py-3 px-4 text-gray-900 dark:text-white">{exam.submissions}</td>
      ...
      {/* Age Distribution */}
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">توزيع الأعمار</h2>
